...
void		ft_un(char **argv, t_pointer_cmd *pointerB, t_pointer **pointera,
				t_file_fd *t_file, t_listp **listp);
void		ft_mid(char **argv, t_pointer_cmd *pointerB, t_pointer **pointera,
				t_file_fd *t_file, t_listp **listp);
...
void		ft_clean_final(t_listp *listp, int j);
...
void    	ft_cmd_exit(char **gv, t_pointer **pointera, t_pointer_cmd *pointerB);
