...
void				ft_thread_clean(t_pointer **pointera, t_list **list,
						pthread_t phi[], t_philo *list_philo);
int					ft_test_deux(t_philo *listp, char *chr,
						unsigned long passed, unsigned long nb);
