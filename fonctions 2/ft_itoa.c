...
L'idée derrière itoa est de prendre un entier, généralement sous forme de type int, et de le convertir en une chaîne de caractères (string) représentant sa valeur.
