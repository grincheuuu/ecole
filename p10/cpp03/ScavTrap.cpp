...
{
    std::cout << "Scavvvv  default contructor called" << std::endl;
    return;
}
...
ScavTrap::ScavTrap(std::string name) : ClapTrap(name)
{
    ...
    std::cout << "Scavvvv  assignement contructor called" << std::endl;
    return;
}

ScavTrap::ScavTrap(ScavTrap const & src) : ClapTrap(src)
{
    std::cout << "Scavvvvvv  copy contructor called" << std::endl;
    *this = src;
    return;
}
...
ScavTrap::~ScavTrap()
{
    std::cout << "Scavvvvvv  destructor called" << std::endl;
}
