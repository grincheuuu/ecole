...
//            System.out.println(Arrays.toString(real_map[i]));
    ...
    private Tile[][]  ft_copie_map(Tile[][] real_map, Tile[][] map)
    {
        Tile[][]      concatMap = map;
...
//        System.out.println();
    ...
    private Tile    ft_random_monster(int p_x, int p_y)
    {
    ...
    private void  ft_print_map(Tile[][] map)
    {
        int w = this.width;
